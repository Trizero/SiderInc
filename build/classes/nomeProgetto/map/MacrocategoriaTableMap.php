...
class MacrocategoriaTableMap extends TableMap
{
	 ...
	 */
	const CLASS_NAME = 'nomeProgetto.map.MacrocategoriaTableMap';
	...
	public function buildRelations()
	{
		...
		$this->addRelation('Categoria', 'Categoria', RelationMap::ONE_TO_MANY, array('id' => 'idMacroCategoria', ), 'CASCADE', null);
	} // buildRelations()
