...
class UtenteTableMap extends TableMap
{
	 ...
	 */
	const CLASS_NAME = 'nomeProgetto.map.UtenteTableMap';
	...
	{
		$this->addRelation('Dettaglioutente', 'Dettaglioutente', RelationMap::ONE_TO_MANY, array('id' => 'idUtente', ), 'CASCADE', null);
		$this->addRelation('Livelloutente', 'Livelloutente', RelationMap::ONE_TO_MANY, array('id' => 'idUtente', ), 'CASCADE', null);
	} // buildRelations()
