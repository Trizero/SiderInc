...
/**
 * Base static class for performing query and update operations on the 'Utente' table.
 *
 * 
 *
...
abstract class BaseUtentePeer {
	...
	const OM_CLASS = 'Utente';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'nomeProgetto.Utente';
	...
	/**
	 * An identiy map to hold any loaded instances of Utente objects.
	 ...
	 * @param      string $column The column name for current table. (i.e. UtentePeer::COLUMN_NAME).
	 * @return     string
	 */
	...
	{
		return UtentePeer::populateObjects(UtentePeer::doSelectStmt($criteria, $con));
	}
	/**
	 ...
	 *
	 * @param      Utente $value A Utente object.
	 ...
	 *
	 * @param      mixed $value A Utente object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Utente) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
				// assume we've been passed a primary key
				$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or Utente object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     Utente Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method to invalidate the instance pool of all tables related to Utente
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key = UtentePeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = UtentePeer::getInstanceFromPool($key))) {
	...
	{
		$key = UtentePeer::getPrimaryKeyHashFromRow($row, $startcol);
		if (null !== ($obj = UtentePeer::getInstanceFromPool($key))) {
			// We no longer rehydrate the object, since this can cause data loss.
			// See http://www.propelorm.org/ticket/509
			// $obj->hydrate($row, $startcol, true); // rehydrate
			$col = $startcol + UtentePeer::NUM_HYDRATE_COLUMNS;
		} else {
			$cls = UtentePeer::OM_CLASS;
			$obj = new $cls();
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseUtentePeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseUtentePeer::TABLE_NAME))
	  {
	...
	{
		return $withPrefix ? UtentePeer::CLASS_DEFAULT : UtentePeer::OM_CLASS;
	}

	/**
	 * Performs an INSERT on the database, given a Utente or Criteria object.
	 *
	 * @param      mixed $values Criteria or Utente object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from Utente object
		}

		if ($criteria->containsKey(UtentePeer::ID) && $criteria->keyContainsValue(UtentePeer::ID) ) {
	...
	/**
	 * Performs an UPDATE on the database, given a Utente or Criteria object.
	 *
	 * @param      mixed $values Criteria or Utente object containing data that is used to create the UPDATE statement.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(UtentePeer::ID);
			if ($value) {
				$selectCriteria->add(UtentePeer::ID, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(UtentePeer::TABLE_NAME);
			}

		} else { // $values is Utente object
	...
	public static function doDeleteAll(PropelPDO $con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += UtentePeer::doOnDeleteCascade(new Criteria(UtentePeer::DATABASE_NAME), $con);
			$affectedRows += BasePeer::doDeleteAll(UtentePeer::TABLE_NAME, $con, UtentePeer::DATABASE_NAME);
			// Because this db requires some delete cascade/set null emulation, we have to
			// clear the cached instance *after* the emulation has happened (since
			// instances get re-added by the select statement contained therein).
			UtentePeer::clearInstancePool();
			UtentePeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof Utente) { // it's a model object
		...
		try {
			...
			$c = clone $criteria;
			$affectedRows += UtentePeer::doOnDeleteCascade($c, $con);
			...
			if ($values instanceof Criteria) {
				...
				UtentePeer::removeInstanceFromPool($values);
			} else { // it's a primary key, or an array of pks
				foreach ((array) $values as $singleval) {
					UtentePeer::removeInstanceFromPool($singleval);
				}
			}
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related Dettaglioutente objects
	...
	/**
	 * Validates all modified columns of given Utente object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      Utente $obj The object to validate.
	...
	public static function doValidate($obj, $cols = null)
	{
		...
		return BasePeer::doValidate(UtentePeer::DATABASE_NAME, UtentePeer::TABLE_NAME, $columns);
	}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = UtentePeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
